      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            Leading supplier of premium vermicompost and earthworm based organic compost. We support farmers and gardeners in achieving healthier soils, stronger plants, and higher yields naturally.
            </p>
